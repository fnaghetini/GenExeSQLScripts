...
txt_server = Label(root, text="Servidor:", bg='white', fg='black', justify=LEFT, anchor='w', padx=10)
tbx_server = Text(root, height=1, width=30, bg='light yellow')
txt_db = Label(root, text="Banco de Dados:", bg='white', fg='black', justify=LEFT, anchor='w', padx=10)
tbx_db = Text(root, height=1, width=30, bg='light yellow')
txt_user = Label(root, text="Usuário:", bg='white', fg='black', justify=LEFT, anchor='w', padx=10)
tbx_user = Text(root, height=1, width=30, bg='light yellow')
txt_pwd = Label(root, text="Senha:", bg='white', fg='black', justify=LEFT, anchor='w', padx=10)
...
btn_generate_scripts.grid(row=3, column=0, columnspan=2, pady=10)
