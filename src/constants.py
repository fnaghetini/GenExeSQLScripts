...
TABLE_KEY_RELATIONSHIP = {'drill_hole': ['hole_number'],
                          ...
                          'udef_dhl_geophysics': ['hole_number', 'depth'],
                          ...
                          'udef_dhl_density_lt': ['hole_number', 'depth_from'],
                          ...
                          'udef_dhl_mag_sus': ['hole_number', 'depth_from'],
                          'udef_dhl_chemistry': ['sample'],
                          'udef_dhl_density_st_fa': ['sample_number']}
